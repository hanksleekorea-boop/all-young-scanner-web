...
const CACHE = 'ays-service-v0.35-real-catalog';
const RELEASE_VERSION = '2026-08-31-service-v0.35';
const CORE = [
  ...
  './readiness.json', './free-advanced-readiness.json', './plus-readiness.json', './stage1-v4-readiness.json', './stage2-readiness.json', './catalog-governance.json', './ad-stage1-readiness.json', './ad-stage2-readiness.json', './ad-stage3-readiness.json', './advertising-config.json', './commercial-launch-readiness.json', './commercial-launch-evidence.json',
  './guides/index.html', './en/', './en/index.html', './content/usage-guides.json', './content/usage-guides.en.json', './content/catalog-v4.json', './content/ingredients-v4.json',
  './assets/free-advanced-app.mjs', './assets/free-advanced-bootstrap.mjs', './assets/catalog-v4.mjs', './assets/ad-policy.mjs', './assets/consent-gate.mjs', './assets/ad-router.mjs', './assets/ad-metrics.mjs', './assets/ad-optimizer.mjs', './assets/adsense-formats.mjs', './assets/ad-loader.mjs', './assets/ad-stage1.css', './assets/privacy-choices-page.mjs', './assets/ad-operations-page.mjs', './assets/ad-governance-page.mjs', './evidence-v035.json',
];

...
assert(free.code.total === 16 && free.code.verified === 15 && free.code.live === 0 && free.code.percent === 93.8, '공개 전 무료 고급 코드 상태 오류');
...
console.log(`[public-verify] PASS — 필수 ${required.length}파일, 무료 고급 15/16 검증·공개 대기, 콘텐츠 24·출처 7, 외부 운영 0/4 분리`);

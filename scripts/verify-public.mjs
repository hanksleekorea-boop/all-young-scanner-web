...
const required = [
  ...
  'readiness.json', 'free-advanced-readiness.json', 'plus-readiness.json', 'stage2-readiness.json', 'catalog-governance.json', 'ad-stage1-readiness.json', 'ad-stage2-readiness.json', 'ad-stage3-readiness.json', 'advertising-config.json', 'commercial-launch-readiness.json', 'commercial-launch-evidence.json', 'commercial-launch-evidence.template.json', 'evidence-v034.json',
  'guides/index.html', 'en/index.html', 'content/usage-guides.json', 'content/usage-guides.en.json', 'assets/free-advanced-app.mjs', 'assets/free-advanced-bootstrap.mjs', 'assets/ad-policy.mjs', 'assets/consent-gate.mjs', 'assets/ad-router.mjs', 'assets/ad-metrics.mjs', 'assets/ad-optimizer.mjs', 'assets/adsense-formats.mjs', 'assets/ad-loader.mjs', 'assets/ad-stage1.css', 'assets/privacy-choices-page.mjs', 'assets/ad-operations-page.mjs', 'assets/ad-governance-page.mjs',
];
...
assert(sw.includes("const RELEASE_VERSION = '2026-08-31-service-v0.34'") && readiness.release_id === '2026-08-31-service-v0.34', '공개 판번호 불일치');

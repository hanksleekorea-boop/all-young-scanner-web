...
assert(evidence.release_id === readiness.release_id && evidence.automatic.total_tests === 81 && evidence.automatic.android_device_selection_tests === 3 && evidence.automatic.free_advanced_unit_tests === 8 && evidence.automatic.plus_unit_tests === 14 && evidence.automatic.virtual_personas === 1000 && evidence.automatic.ad_safety_personas === 1000 && evidence.automatic.ad_stage2_regional_personas === 2000 && evidence.automatic.ad_stage3_advanced_scenarios === 20000 && evidence.automatic.account_required === false, '현재판 자동 증거 불일치');

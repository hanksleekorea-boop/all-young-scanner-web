...
const required = [
  ...
  'readiness.json', 'free-advanced-readiness.json', 'plus-readiness.json', 'stage1-v4-readiness.json', 'stage2-readiness.json', 'catalog-governance.json', 'ad-stage1-readiness.json', 'ad-stage2-readiness.json', 'ad-stage3-readiness.json', 'advertising-config.json', 'commercial-launch-readiness.json', 'commercial-launch-evidence.json', 'commercial-launch-evidence.template.json', 'evidence-v035.json',
  'guides/index.html', 'en/index.html', 'content/usage-guides.json', 'content/usage-guides.en.json', 'content/catalog-v4.json', 'content/ingredients-v4.json', 'assets/free-advanced-app.mjs', 'assets/free-advanced-bootstrap.mjs', 'assets/catalog-v4.mjs', 'assets/ad-policy.mjs', 'assets/consent-gate.mjs', 'assets/ad-router.mjs', 'assets/ad-metrics.mjs', 'assets/ad-optimizer.mjs', 'assets/adsense-formats.mjs', 'assets/ad-loader.mjs', 'assets/ad-stage1.css', 'assets/privacy-choices-page.mjs', 'assets/ad-operations-page.mjs', 'assets/ad-governance-page.mjs',
];
...
assert(sw.includes("const RELEASE_VERSION = '2026-08-31-service-v0.35'") && readiness.release_id === '2026-08-31-service-v0.35', '공개 판번호 불일치');
assert(catalog.products.length === 500 && new Set(catalog.products.map((row) => row.gtin)).size === 500 && catalog.counts.human_reviewed_products === 0, 'v4 실제 상품 원장 수량·검수 분리 오류');
assert(ingredientCatalog.ingredients.length === 300 && ingredientCatalog.human_editorial_complete === false, 'v4 성분명 원장 수량·사람 검수 분리 오류');
...
assert((guideIndex.match(/class="guide-card"/g) || []).length === 24 && (englishIndex.match(/class="guide-card"/g) || []).length === 24 && (sitemap.match(/<url>/g) || []).length === 35 && sitemap.includes('catalog-license.html'), '한국어·영문 가이드 목록 또는 사이트맵 수 불일치');

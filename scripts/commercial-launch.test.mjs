...
const complete = () => ({
  schema_version: 1,
  release_id: '2026-08-30-service-v0.33',
  ...
  android: { release_id: '2026-08-30-service-v0.33', device_model: 'A56', journeys_passed: 3, completed_at: '2026-08-30', evidence_url: proof('android') },
  ios: { release_id: '2026-08-30-service-v0.33', device_model: 'iPhone', journeys_passed: 3, completed_at: '2026-08-30', evidence_url: proof('ios') },

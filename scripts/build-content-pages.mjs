...
const indexBody = `<main><div class="wrap"><div class="hero"><div class="eyebrow">K-뷰티 사용 가이드 24</div><h1>헷갈리지 않게, 하나씩 따라 해요</h1><p class="lead">기본 루틴부터 제품 조합과 불편 신호까지, 출처와 확인일을 갖춘 24개 안내를 모았습니다.</p></div><label for="guide-search" class="eyebrow">가이드 검색</label><input id="guide-search" class="search" type="search" inputmode="search" autocomplete="off" placeholder="예: 선크림, 세안, 보습"><p id="guide-empty" class="empty" role="status">검색어와 맞는 가이드가 없습니다.</p><div id="guide-grid" class="grid">${cardsHtml}</div><div class="notice" style="margin-top:24px"><strong>안전한 정보 이용</strong><span>제품별 사용량과 순서는 표시사항이 우선입니다. 이 가이드는 의료 진단이나 치료를 대신하지 않습니다.</span></div></div></main>`;
...
await writeFile(path.join(guidesDir, 'index.html'), shell({ title: 'K-뷰티 사용 가이드 24', description: '출처와 확인일을 갖춘 올영스캐너 K-뷰티 사용 가이드 24개', canonical: `${baseUrl}guides/`, body: indexBody, script: indexScript }).replaceAll('href="../../"', 'href="../"').replaceAll('href="../">사용 가이드', 'href="./">사용 가이드'), 'utf8');

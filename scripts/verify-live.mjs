...
const expectedRelease = '2026-08-30-service-v0.29';
const paths = ['', 'progress.html', 'offline.html', 'privacy.html', 'terms.html', 'support.html', 'manifest.webmanifest', 'readiness.json', 'free-advanced-readiness.json', 'plus-readiness.json', 'evidence-v029.json'];
const results = [];

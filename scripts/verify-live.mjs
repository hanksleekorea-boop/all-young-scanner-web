...
const expectedRelease = '2026-08-31-service-v0.35';
const paths = ['', 'en/', 'guides/', 'progress.html', 'offline.html', 'privacy.html', 'terms.html', 'support.html', 'about.html', 'cookies.html', 'advertising.html', 'ad-operations.html', 'ad-governance.html', 'privacy-choices.html', 'catalog-license.html', 'ads.txt', 'robots.txt', 'sitemap.xml', 'manifest.webmanifest', 'content/usage-guides.en.json', 'content/catalog-v4.json', 'content/ingredients-v4.json', 'readiness.json', 'free-advanced-readiness.json', 'plus-readiness.json', 'stage1-v4-readiness.json', 'ad-stage1-readiness.json', 'ad-stage2-readiness.json', 'ad-stage3-readiness.json', 'advertising-config.json', 'commercial-launch-readiness.json', 'commercial-launch-evidence.json', 'evidence-v035.json'];
const results = [];
